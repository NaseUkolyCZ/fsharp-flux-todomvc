...
let website = "/fsharp-flux-todomvc"

let githubLink = "http://github.com/NaseUkolyCZ/fsharp-flux-todomvc"

// Specify more information about your project
let info =
  [ "project-name", "fsharp-flux-todomvc"
    "project-author", "David Podhola"
    "project-summary", "Flux TodoMVC Example with server implemented in FSharp"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/fsharp-flux-todomvc" ]
